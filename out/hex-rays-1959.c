...
if ( v9 > -0.00001 && v9 < 0.00001 )
return 0LL;
v10 = 1.0 / v9;
v17 = *a1 - *a3;
v18 = a1[1] - a3[1];
v19 = a1[2] - a3[2];
*a7 = (v22 * v19 + v17 * v20 + v21 * v18) * (1.0 / v9);
if ( *a7 < 0.0 || *a7 > 1.0 )
return 0LL;
*a8 = ((v12 * v17 - v11 * v18) * a2[2] + *a2 * (v13 * v18 - v12 * v19) + (v11 * v19 - v13 * v17) * a2[1]) * v10;
if ( *a8 < 0.0 || *a8 + *a7 > 1.0 )
return 0LL;
*a6 = ((v12 * v17 - v11 * v18) * v16 + v14 * (v13 * v18 - v12 * v19) + (v11 * v19 - v13 * v17) * v15) * v10;
return 1LL;
}