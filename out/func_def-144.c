...
# 1 
static void rifft8pt(float *ioptr, float scale)
{

    float w0r = (float) (1.0 / 1.414213562373095048801688724209698078569);
    ...
    f5r = Two * t0r - f6r;
    f5i = f6i - Two * t0i;
# 2832 "/scratch/repos/new/home/jordi_armengol_estape/c-scraper/outputs/2022-01-22/02-19-57/repos/narner/AudioKit/refs/heads/master/AudioKit/Common/Internals/Soundpipe/lib/fft/fft.c"
    t0r = f0r + f1r;
    t0i = f0i - f1i;
    f1r = f0r - f1r;
    f1i = f0i + f1i;
